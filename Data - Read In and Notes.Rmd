...
![](Bin_Trunc_Chrom_PAL_3_DCM_F.png)  \
![](Bin_Trunc_Chrom_PAL_6_DCM_F.png)  \
![](Bin_Trunc_Chrom_PAL_7_DCM_F.png)  \
![](Bin_Trunc_Chrom_PAL_14_DCM_F.png)  \
![](Bin_Trunc_Chrom_PAL_15_DCM_F.png)  \
![](Bin_Trunc_Chrom_PAL_17_DCM_F.png)  \
![](Bin_Trunc_Chrom_PAL_18_DCM_F.png)  \
![](Bin_Trunc_Chrom_PAL_43_DCM_F.png)  \
![](Bin_Trunc_Chrom_PAL_44_DCM_F.png)  \
![](Bin_Trunc_Chrom_PAL_48_DCM_F.png)   \
![](Bin_Trunc_Chrom_PAL_50_DCM_F.png)   \
![](Bin_Trunc_Chrom_PAL_130_DCM_F.png)  \
![](Bin_Trunc_Chrom_PAL_131_DCM_F.png)  \
![](Bin_Trunc_Chrom_PAL_133_DCM_F.png)  \
![](Bin_Trunc_Chrom_PAL_134_DCM_F.png)  \
![](Bin_Trunc_Chrom_PAL_248_DCM_F.png)  \
![](Bin_Trunc_Chrom_PAL_270_DCM_F.png)  \
![](Bin_Trunc_Chrom_PAL_302_DCM_F.png)  \
![](Bin_Trunc_Chrom_PAL_333_DCM_F.png)  \
![](Bin_Trunc_Chrom_PAL_334_DCM_F.png)  \
![](Bin_Trunc_Chrom_PAL_374_DCM_F.png)  \
![](Bin_Trunc_Chrom_PAL_378_DCM_F.png)  \
![](Bin_Trunc_Chrom_PAL_382_DCM_F.png)  \
![](Bin_Trunc_Chrom_PAL_227_DCM_F.png)  \

\pagebreak

**Gas Chromatograms (Truncated and Showing Bins) - Clade D (DCM)** \
![](Bin_Trunc_Chrom_PAL_29_DCM_D.png)  \
![](Bin_Trunc_Chrom_PAL_247_DCM_D.png)  \
![](Bin_Trunc_Chrom_PAL_252_DCM_D.png)  \
![](Bin_Trunc_Chrom_PAL_299_DCM_D.png)  \
![](Bin_Trunc_Chrom_PAL_300_DCM_D.png)  \
![](Bin_Trunc_Chrom_PAL_306_DCM_D.png)  \
![](Bin_Trunc_Chrom_PAL_332_DCM_D.png)  \
![](Bin_Trunc_Chrom_PAL_340_DCM_D.png)  \
![](Bin_Trunc_Chrom_PAL_355_DCM_D.png)  \
![](Bin_Trunc_Chrom_PAL_359_DCM_D.png)   \


\pagebreak

**Gas Chromatograms (Truncated and Showing Bins) - Trocheliophorum (DCM)** \
![](Bin_Trunc_Chrom_PAL_19_DCM_T.png)  \
![](Bin_Trunc_Chrom_PAL_42_DCM_T.png)  \
![](Bin_Trunc_Chrom_PAL_45_DCM_T.png)  \
![](Bin_Trunc_Chrom_PAL_52_DCM_T.png)  \
![](Bin_Trunc_Chrom_PAL_137_DCM_T.png)  \
![](Bin_Trunc_Chrom_PAL_250_DCM_T.png)  \
![](Bin_Trunc_Chrom_PAL_301_DCM_T.png)  \
![](Bin_Trunc_Chrom_PAL_307_DCM_T.png)  \
![](Bin_Trunc_Chrom_PAL_356_DCM_T.png)  \
![](Bin_Trunc_Chrom_PAL_362_DCM_T.png)   \
![](Bin_Trunc_Chrom_PAL_379_DCM_T.png)  

\pagebreak

**Gas Chromatograms (Truncated and Showing Bins) - Clade F (HEX)** \
![](Bin_Trunc_Chrom_PAL_1_HEX_F.png)  \
![](Bin_Trunc_Chrom_PAL_3_HEX_F.png)  \
![](Bin_Trunc_Chrom_PAL_7_HEX_F.png)  \
![](Bin_Trunc_Chrom_PAL_14_HEX_F.png)  \
![](Bin_Trunc_Chrom_PAL_15_HEX_F.png)  \
![](Bin_Trunc_Chrom_PAL_17_HEX_F.png)  \
![](Bin_Trunc_Chrom_PAL_18_HEX_F.png)  \
![](Bin_Trunc_Chrom_PAL_43_HEX_F.png)  \
![](Bin_Trunc_Chrom_PAL_44_HEX_F.png)  \
![](Bin_Trunc_Chrom_PAL_130_HEX_F.png)  \
![](Bin_Trunc_Chrom_PAL_131_HEX_F.png)  \
![](Bin_Trunc_Chrom_PAL_133_HEX_F.png)  \
![](Bin_Trunc_Chrom_PAL_270_HEX_F.png)  \
![](Bin_Trunc_Chrom_PAL_333_HEX_F.png)  \
![](Bin_Trunc_Chrom_PAL_334_HEX_F.png)  \
![](Bin_Trunc_Chrom_PAL_374_HEX_F.png)  \
![](Bin_Trunc_Chrom_PAL_378_HEX_F.png)  \
![](Bin_Trunc_Chrom_PAL_382_HEX_F.png)  \

\pagebreak

**Gas Chromatograms (Truncated and Showing Bins) - Clade D (HEX)** \
\
![](Bin_Trunc_Chrom_PAL_29_HEX_D.png)  \
![](Bin_Trunc_Chrom_PAL_46_HEX_D.png)  \
![](Bin_Trunc_Chrom_PAL_252_HEX_D.png)  \
![](Bin_Trunc_Chrom_PAL_299_HEX_D.png)  \
![](Bin_Trunc_Chrom_PAL_332_HEX_D.png)  \
![](Bin_Trunc_Chrom_PAL_340_HEX_D.png)  \
![](Bin_Trunc_Chrom_PAL_355_HEX_D.png)  \
![](Bin_Trunc_Chrom_PAL_359_HEX_D.png)   \

\pagebreak

**Gas Chromatograms (Truncated and Showing Bins) - Trocheliophorum (HEX)** \
![](Bin_Trunc_Chrom_PAL_19_HEX_T.png)  \
![](Bin_Trunc_Chrom_PAL_42_HEX_T.png)  \
![](Bin_Trunc_Chrom_PAL_250_HEX_T.png)  \
![](Bin_Trunc_Chrom_PAL_356_HEX_T.png)  \
![](Bin_Trunc_Chrom_PAL_362_HEX_T.png)   \
![](Bin_Trunc_Chrom_PAL_375_HEX_T.png)   \
![](Bin_Trunc_Chrom_PAL_379_HEX_T.png)   
...
```{r statisticalpackages, include=INCLUDE_SETTING}
citation("stats")
citation("MASS")
```
...
```{r otherpackages, include=INCLUDE_SETTING}
citation("knitr")
citation("base")
citation("corrplot")
citation("plot3D")
