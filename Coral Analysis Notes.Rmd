...
#PAL375DCM1 = read.csv(filenamesDCM[45],header=FALSE) Chromatogram indicates nothing injected - removed
...
<<<<<<< HEAD
#setwd("2016 Raw Data/All HEX")
setwd("~/CoralProject/2016 Raw Data/ALL HEX")
=======
setwd("..")
setwd("All HEX")
>>>>>>> dd0a453aeb4d5d0f75ce0a8581e27bb2145a3f96
...
#PAL250HEX2 = read.csv(filenamesHEX[18],header=FALSE) Used PAL250HEX1 since graph of PAL250HEX2 less consistent with other HEX trochis 
...
correlation_1100 = cor(PC_HEX,binned_matrixHEX_1100)
install.packages("corrplot", repos='http://cran.us.r-project.org')
library(corrplot)
corrplot(t(correlation_1100), method="color")
```
...
correlation_2000 = cor(PC_HEX,binned_matrixHEX_2000)
install.packages("corrplot", repos='http://cran.us.r-project.org')
library(corrplot)
corrplot(t(correlation_2000), method="color")
```
...
correlation_3000 = cor(PC_HEX,binned_matrixHEX_3000)
install.packages("corrplot", repos='http://cran.us.r-project.org')
library(corrplot)
corrplot(t(correlation_3000), method="color")
```
...
```{r}
binned_matrix_1100 = binner(dataframe[,1:47008],1100, DELTA)
binned_matrix_1300 = binner(dataframe[,1:47008],1300, DELTA)
binned_matrix_1500 = binner(dataframe[,1:47008],1500, DELTA)
binned_matrix_1600 = binner(dataframe[,1:47008],1600, DELTA)
binned_matrix_1800 = binner(dataframe[,1:47008],1800, DELTA)
binned_matrix_2000 = binner(dataframe[,1:47008],2000, DELTA)
```
